...
docker network create --subnet 10.10.0.0/24 --attachable --driver overlay my-net
...
# a linux system for network test
docker run -it --rm --network my-net --name alpine0 alpine /bin/ash